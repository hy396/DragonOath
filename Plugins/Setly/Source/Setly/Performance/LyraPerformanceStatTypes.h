...
enum class ELyraDisplayablePerformanceStat : uint8
{
	...
	// Input-to-game latency (placeholder until platform latency markers are wired up)
	Latency_Game,

	// Render latency (placeholder until platform latency markers are wired up)
	Latency_Render,

	// Total end-to-end latency (placeholder until platform latency markers are wired up)
	Latency_Total,
