...
TSharedRef<IDetailCustomization> FLexUIStaticSpriteAtlasDataCustomization::MakeInstance()
{
	return MakeShareable(new FLexUIStaticSpriteAtlasDataCustomization);
}

void FLexUIStaticSpriteAtlasDataCustomization::CustomizeDetails(IDetailLayoutBuilder& DetailBuilder)
{
